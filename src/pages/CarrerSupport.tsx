  ...
  return (
    <div className="carrersupport flex w-full h-full">
      ...
      <div className="container ">
        ...
        <p>We offer a variety of training programs, workshops, and courses to enhance your skills.
Our focus is on helping you acquire new abilities and improve existing ones for career advancement.
Gain the knowledge and expertise needed to excel in your field with our tailored programs.</p>
      </div>
      <img src="https://images.pexels.com/photos/4100669/pexels-photo-4100669.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
    </div>
  );
};
